summon minecraft:armor_stand -12.0 191.5 -223.0 {Invisible:1b,Invulnerable:1b,Small:1b,CustomNameVisible:1b,CustomName:'[{"text":"1.  ","color":"aqua"},{"text":"Faction 3","color":"yellow"}]',Tags:["SCORES","FACTION3"],NoAI:1,NoGravity:1}
