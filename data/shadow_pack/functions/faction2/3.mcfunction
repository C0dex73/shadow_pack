summon minecraft:armor_stand -12.0 190.5 -223.0 {Invisible:1b,Invulnerable:1b,Small:1b,CustomNameVisible:1b,CustomName:'[{"text":"3.  ","color":"aqua"},{"text":"AINCRAD","color":"yellow"}]',Tags:["SCORES","FACTION2"],NoAI:1,NoGravity:1}
