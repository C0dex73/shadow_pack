summon minecraft:armor_stand -12.0 190.0 -223.0 {Invisible:1b,Invulnerable:1b,Small:1b,CustomNameVisible:1b,CustomName:'[{"text":"4.  ","color":"aqua"},{"text":"OSARIA","color":"yellow"}]',Tags:["SCORES","FACTION1"],NoAI:1,NoGravity:1}
