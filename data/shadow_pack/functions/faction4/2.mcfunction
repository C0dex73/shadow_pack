summon minecraft:armor_stand -12.0 191.0 -223.0 {Invisible:1b,Invulnerable:1b,Small:1b,CustomNameVisible:1b,CustomName:'[{"text":"2.  ","color":"aqua"},{"text":"UNKNOW","color":"yellow"}]',Tags:["SCORES","FACTION4"],NoAI:1,NoGravity:1}
